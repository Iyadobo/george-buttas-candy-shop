# b9f3934d-fc72-4dc3-bd7d-72629b73df95 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `george-butta-candy-shop.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `george-butta-candy-shop.html`
...
- A single self-contained `george-butta-candy-shop.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `george-butta-candy-shop.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `FCDB33E0-CAA2-42B2-B1EF-90647EB404C4.png`
- `george-butta-candy-shop.png`
- `image-1.png`
- `image.png`
- `IMG_6127.jpg`

## Coding checklist for AI tools
1. Inspect `george-butta-candy-shop.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
